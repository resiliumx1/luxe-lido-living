  ...
  return (
    <div className="bg-off-white">
      ...
      <div className="relative h-[50vh] min-h-[380px] flex items-end pb-20">
        <img src={heroImg} alt="Ashante Lindsay" className="absolute inset-0 w-full h-full object-cover" />
        ...
        <div className="relative max-w-[1280px] mx-auto px-6 md:px-10 w-full">
          ...
          <h1 className="font-serif text-5xl md:text-7xl text-off-white font-medium leading-none">About Ashante</h1>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
            ...
            <div className="relative sticky top-28">
              <div className="relative z-10">
                <img src={ashanteImg} alt="Ashante Lindsay" className="w-full object-cover aspect-[4/5]" />
              </div>
            ...
            <div>
              ...
              <h2 className="font-serif text-4xl text-ocean-deep mb-6">Rooted in the Caribbean</h2>
              <div className="space-y-4 font-sans text-ocean-mid text-base leading-relaxed">
                <p>
      ...
      <section className="py-20 bg-sand-light">
        <div className="max-w-[1280px] mx-auto px-6 md:px-10 text-center">
          ...
          <h2 className="font-serif text-3xl text-ocean-deep mb-10">Specialties</h2>
          <div className="flex flex-wrap justify-center gap-3">
            {specialties.map((s) => (
              <span key={s} className="border border-sand bg-off-white text-teal small-caps text-xs font-sans tracking-wider px-5 py-2.5">
                {s}
              </span>
            ))}
          </div>
      ...
      <section className="py-24 bg-off-white">
        <div className="max-w-[800px] mx-auto px-6 md:px-10 text-center">
          ...
          <blockquote className="font-serif italic text-2xl md:text-3xl text-ocean-deep leading-relaxed mb-6">
