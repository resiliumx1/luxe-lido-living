...
const properties: Property[] = [
  ...
  },
  {
    ...
    description: "Pelican Point is a grand St. John's estate with seven bedrooms spread across a main residence and two guest pavilions. Its generous layout works well for large families, visiting guests and group entertaining.",
  ...
  },
  {
    ...
    description: "Elevated above Jolly Harbour with sweeping marina views, this contemporary manor blends indoor-outdoor living. Four generous bedroom suites, a rooftop terrace and a resort-style pool provide space for family life and entertaining.",
  ...
  },
  {
    ...
    description: "Dramatically sited on a cliff edge above Half Moon Bay, this estate offers uninterrupted Atlantic Ocean views. Its concrete and glass design includes five generous suites, each opening onto a private terrace above the sea.",
  ...
  },
  {
    ...
    description: "A sleek two-container conversion in St. John's featuring soaring ceilings, polished concrete floors, and a mezzanine bedroom overlooking the Caribbean Sea. A practical option for couples or compact living.",
  ...
  },
  {
    ...
    description: "An attainable entry into Caribbean property, this two-bedroom prefab cottage suits couples, retirees or a small family. East-facing orientation captures every morning sunrise over the harbour.",
    features: ["East-facing sunrise views", "Attainable home", "Two generous bedrooms", "Low maintenance", "Move-in ready"],
    categoryHref: "/prefab-homes",
  },
  {
  ...
  },
  {
    ...
    description: "Spacious insulated-panel living in English Harbour with four bedrooms, a rooftop observation deck and a plunge pool. Floor-to-ceiling windows frame harbour views from every room.",
    features: ["Rooftop observation deck", "Plunge pool", "Floor-to-ceiling windows", "Harbour views", "Durable finishes", "Solar power ready"],
    badge: "New Listing",
    categoryHref: "/prefab-homes",
  },
];
