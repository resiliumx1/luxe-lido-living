  ...
  return (
    ...
    >
      ...
      <span
        ...
        style={{ backgroundColor: "hsla(var(--gold) / 0.35)" }}
      />
      {/* Button */}
      <span
        className="relative flex items-center justify-center rounded-full shadow-lg transition-transform duration-300 group-hover:scale-110"
        style={{ width: "56px", height: "56px", backgroundColor: "hsl(var(--gold))" }}
      >
